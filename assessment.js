...
var shortNames = friends.filter(e => e.length < 4) // CODE HERE
...
var shorty = friends.map((e) => nickNameMaker(e)); // CODE HERE
...
// CODE HERE
var plusThree = numbers.map((e) => e += 3);
...
// CODE HERE
goodPeople.forEach((e) => e.family = true);
